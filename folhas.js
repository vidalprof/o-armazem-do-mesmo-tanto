...
function f0(d){
  ...
  c.innerHTML =
    ...
    '<div class="cena"><i class="foco"></i>' + '<div class="it" style="animation-delay:0.00s">' + '<img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/mu_maca.png?v=' + V + '" alt="">' + '<span class="rt">3</span>' + '</div>' + '<div class="it" style="animation-delay:0.35s">' + '<img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/mu_laranja.png?v=' + V + '" alt="">' + '<span class="rt">3</span>' + '</div>' + '<div class="it" style="animation-delay:0.70s">' + '<img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/mu_bolo.png?v=' + V + '" alt="">' + '<span class="rt">3</span>' + '</div>' + '<div class="it" style="animation-delay:1.05s">' + '<img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/mu_sorvete.png?v=' + V + '" alt="">' + '<span class="rt">3</span>' + '</div>' + '</div><div class="prat"></div>' +
